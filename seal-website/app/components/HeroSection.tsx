        ...
        <div className="relative h-screen">
            ...
            <div className="absolute w-full h-full bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-4">
                <div className="text-white">
                    <SectionHeading title="S.E.A.L." />
                </div>
                <div className="text-white">
                    <SubHeader text="Social Equity Action Lab" />
                </div>
                <p className="text-white text-2xl sm:text-3xl md:text-3xl lg:text-5xl xl:text-5xl pt-5 max-w-5xl mx-auto">
